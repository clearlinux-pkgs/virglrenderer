...
Source0  : https://gitlab.freedesktop.org/virgl/virglrenderer/-/archive/virglrenderer-1.1.1/virglrenderer-virglrenderer-1.1.1.tar.gz
...
%prep
%setup -q -n virglrenderer-virglrenderer-1.1.1
cd %{_builddir}/virglrenderer-virglrenderer-1.1.1
pushd ..
cp -a virglrenderer-virglrenderer-1.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743637651
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libvirglrenderer.so.1.9.1
/usr/lib64/libvirglrenderer.so.1
/usr/lib64/libvirglrenderer.so.1.9.1
