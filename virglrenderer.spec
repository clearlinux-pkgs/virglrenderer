...
Source0  : https://gitlab.freedesktop.org/virgl/virglrenderer/-/archive/virglrenderer-0.10.1/virglrenderer-virglrenderer-0.10.1.tar.gz
...
%prep
%setup -q -n virglrenderer-virglrenderer-0.10.1
cd %{_builddir}/virglrenderer-virglrenderer-0.10.1
pushd ..
cp -a virglrenderer-virglrenderer-0.10.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662482324
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libvirglrenderer.so.1.7.5
/usr/lib64/libvirglrenderer.so.1
/usr/lib64/libvirglrenderer.so.1.7.5
