...
Version  : 0.10.3
Release  : 3
URL      : https://gitlab.freedesktop.org/virgl/virglrenderer/-/archive/0.10.3/virglrenderer-0.10.3.tar.gz
Source0  : https://gitlab.freedesktop.org/virgl/virglrenderer/-/archive/0.10.3/virglrenderer-0.10.3.tar.gz
...
%prep
%setup -q -n virglrenderer-0.10.3
cd %{_builddir}/virglrenderer-0.10.3
pushd ..
cp -a virglrenderer-0.10.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663624361
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libvirglrenderer.so.1.7.6
/usr/lib64/libvirglrenderer.so.1
/usr/lib64/libvirglrenderer.so.1.7.6
