...
Source0  : https://gitlab.freedesktop.org/virgl/virglrenderer/-/archive/virglrenderer-1.1.0/virglrenderer-virglrenderer-1.1.0.tar.gz
...
%prep
%setup -q -n virglrenderer-virglrenderer-1.1.0
cd %{_builddir}/virglrenderer-virglrenderer-1.1.0
pushd ..
cp -a virglrenderer-virglrenderer-1.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725965630
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libvirglrenderer.so.1.9.0
/usr/lib64/libvirglrenderer.so.1
/usr/lib64/libvirglrenderer.so.1.9.0
